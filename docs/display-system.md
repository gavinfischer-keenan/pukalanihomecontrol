...
* **Service**: `corner-kiosk.service` runs Chromium on HDMI-3 (`--window-size=1920,1080 --window-position=0,0`).
...
* **Layout**: Auto-detects tile size via `ResizeObserver` or user override (1080/720/540/480/360).
