...
| `aqara_cam_6` (roof_view) | Roof View (Diamond Head) | 192.168.1.30 | `18:C2:3C:7A:E9:DB` | 646:145 | `/ch2` (1080p) | `/ch1` (1536p) |
| Slots 7-9 | Reserved | - | - | - | - | - |
...
* **Diamond Head All-Time Timelapse:** CT114 `roofcam` persistent capture daemon captures snapshots from `aqara_cam_6` (`192.168.1.30:8554/ch1`).
